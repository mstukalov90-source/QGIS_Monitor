...
4. Символика камер; группа «Собственность» — 3 слоя (`город Москва`, `Нет данных о правообладателе`, `Частная собственность`); «Фото разрытий» — точки с красной обводкой; контур «Границы районов».
