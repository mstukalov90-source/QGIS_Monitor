...
- Загрузка слоёв — только по кнопке **Загрузить слои Monitor DB** в меню **Monitor DB Loader** или на панели инструментов.
...
4. GenPlan — только `disruption = true`; **Разрытия из паспортов ОГХ** — чёрные пирамиды; КГС/АВР/ОПС — пустые заглушки; **Объекты ДГИ и ООЗТ** скрыты по умолчанию.
